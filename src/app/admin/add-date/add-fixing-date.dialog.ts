...
@Component({
  selector: 'app-add-fixing-date',
  templateUrl: './add-fixing-date.dialog.html',
  styleUrls: ['./add-fixing-date.dialog.less'],
})
export class AddFixingDateDialog {
  ...
  constructor(
    ...
    private readonly dialogRef: MatDialogRef<AddFixingDateDialog>,
  ) {}
  ...
  addDate() {
    ...
    this.firebase.createDateWithDescription(startDate, endDate, this.availableSlots, 'fixing', this.description);
